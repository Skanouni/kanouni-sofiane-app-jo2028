...
<body>
    ...
    <main>
        ...
        try {
            ...
            $query = "SELECT * FROM EPREUVE e
                      INNER JOIN LIEU l ON l.id_lieu = e.id_lieu
                      INNER JOIN SPORT s ON s.id_sport = e.id_sport
            ...
            if ($statement->rowCount() > 0) {
                echo "<table>";
                echo "<tr><th class='color'>Sport</th><th class='color'>Epreuve</th><th class='color'>Date</th><th class='color'>Heure</th><th class='color'>Lieu</th></tr>";
